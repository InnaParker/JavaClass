...
public class Repl06 {
	...
	public static void main(String[] args) {
		...
		* Create a float data type variable name is ed, and the value 
		* should be 8.2. Multiply the value by itself. and print the 
		* result. Your output should be as following:
